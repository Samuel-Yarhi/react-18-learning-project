export const UserGreeting = () => {
    ...
    //Short-circuit && operator, this first checks the isLoggedIn expression and then the right side of code.
    //If the expression is false, it no longer checks the right side of the expression (performance-friendly),
    //causing a "short circuit" because it skipped that part of code
}